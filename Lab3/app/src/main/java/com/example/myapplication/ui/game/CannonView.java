...
public class CannonView extends SurfaceView
    ...
    public static final double TARGET_WIDTH_PERCENT = 2.0 / 40;
    public static final double TARGET_LENGTH_PERCENT = 2.0 / 20;
    public static final double TARGET_FIRST_X_PERCENT = 2.0 / 5;
    ...
    public static final double BLOCKER_X_PERCENT = 2.0 / 2;
    ...
    public void newGame() {
        ...
        for (int n = 0; n < TARGET_PIECES; n++) {
            ...
            targets.add(new Target(this, 0, HIT_REWARD, targetX, targetY,
